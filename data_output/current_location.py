...
class CentralRole:
    ...
    def main(self, around_point, now_frame):
        ...
        old_point = this_point[departure_point + old_adjustment]
        next_point = this_point[departure_point + old_adjustment]

        old_time = this_time[departure_point + old_adjustment]
        next_time = this_time[departure_point + old_adjustment]
