...
class GUI:
    def __init__(self, all_data, all_UI_data):
    ...
    def main(self):
        ...
        send_main = self.all_data.operation["plugin"]["other"]["window_data"].SendWindowData(None, self.all_data, UI_parts, UI_auxiliary, self.all_UI_data)
        ...
        for key in list(expansion_keys):
            ...
            if key != GUI_main_name:
                send_sub = self.all_data.operation["plugin"]["other"]["window_data"].SendWindowData(expansion_list["main"].window, self.all_data, UI_parts, UI_auxiliary, self.all_UI_data)
