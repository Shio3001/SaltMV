...
class GUI:
    ...
    def main(self):
        ...
        send_main = self.all_data.operation["plugin"]["other"]["window_data"].SendWindowData(None, self.all_data.operation, UI_parts, UI_auxiliary)
        ...
        for key in list(expansion_keys):
            ...
            if key != GUI_main_name:
                send_sub = self.all_data.operation["plugin"]["other"]["window_data"].SendWindowData(expansion_list["main"].window, self.all_data.operation, UI_parts, UI_auxiliary)
