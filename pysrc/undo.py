...
class UndoStack:
    def __init__(self, edit_data_control):
    ...
    def add_stack(self, stop_once=None, media_id=None, effect_id=None, classification=None, add_type=None, func=None):
        ...
        #print(self.edit_data_control, media_id, effect_id, classification, add_type, func)
        undo = UndoStackData(self.edit_data_control, media_id, effect_id, classification, add_type, func)
        if stop_once:
...
class UndoStackData:
    def __init__(self, edit_data_control, media_id, effect_id, classification, add_type, func):
        self.edit_data_control = edit_data_control
        ...
        if not self.media_id is None:
            self.target_media_data = copy.deepcopy(self.edit_data_control.media_object_had_layer(self.media_id))
    ...
    def set_split_media(self, split_media_id):
        ...
        self.target_media_data_split = copy.deepcopy(self.edit_data_control.media_object_had_layer(self.split_media_id))
